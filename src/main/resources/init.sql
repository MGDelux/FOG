...
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES (''38x73 mm. taglægte T1 læmgde 420'', ''420'', 5,
        ''toplægte til montering af rygsten lægges i toplægte holde '',
        ''50.00'');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
...
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES (''45x195 mm. spærtræ ubh. længde 480'', ''480'', 5, ''Remme i sider,
        sadles ned	i stolper (skur del, deles)'',
        ''40.00'');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
