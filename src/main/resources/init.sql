DROP
DATABASE IF EXISTS `FOG`;
CREATE
DATABASE IF NOT EXISTS `FOG`;
USE
FOG;

DROP
USER IF exists 'FOG'@'localhost';
CREATE
USER 'FOG'@'localhost' IDENTIFIED BY 'pass';
GRANT ALL PRIVILEGES ON FOG.* TO
'FOG'@'localhost';
...
(
    ...
    `shed_length`    INT,
    `shed_height`    INT,
    CONSTRAINT PK_forespørgsler PRIMARY KEY (`Order_Id`, `kunde`),
...
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,`materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x150 mm. trykimp. Bræt læmgde 480', '480', 5, 'Vindskeder på rejsning', '50.00');

INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,`materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x150 mm. trykimp. Bræt læmgde 600', '600', 5, 'Sternbrædder til siderne Carport del', '50.00');

INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,`materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x150 mm. trykimp. Bræt læmgde 540', '540', 5, 'Sternbrædder til siderne Skur del (deles)', '50.00');
...
VALUES ('19x100 mm. trykimp. Bræt læmgde 480', '480', 5, 'Vand bræt på vindskeder', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('19x100 mm. trykimp. Bræt læmgde 240', '240', 5, 'beklædning af gavle 1 på 2', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('19x100 mm. trykimp. Bræt læmgde 210', '210', 5, 'Beklædning af skur 1 på 2 ', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x50 mm. trykimp. Bræt læmgde 540', '540', 5, 'til montering oven på tagfodslægte', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
...
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x200 mm. trykimp. Brædt længde 360', '360', 5, 'understernbrædder til for & bag ende', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x200	mm.	trykimp.Brædt længde 540', '540', 5, 'understernbrædder til siderne', '60.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x125mm. trykimp. Brædt længde 360', '360', 5, 'oversternbrædder til forenden', '50.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('25x125mm. trykimp. Brædt længde 540', '540', 5, 'oversternbrædder til siderne', '60.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
...
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('19x100 mm. trykimp. Brædt længde 210', '210', 5, 'til beklædning af skur 1 på 2', '40.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
VALUES ('19x100 mm. trykimp. Brædt  længde 360', '360', 5, 'vandbrædt på stern i forende', '40.00');
INSERT INTO `fog`.`CartPortMaterialer` (`Carportmateriale_Navn`, `Carportmateriale_length`, `Carportmateriale_antal`,
                                        `materiale_Beskrivelse`, `materiale_Pris`)
