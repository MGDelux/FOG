...
<head>
    ...
    <script>
        function myFunction() {
            document.getElementById("customvalue").value = ${requestScope.sumWithMoms};
        }
    </script>
    <style>
...
<form method="post">
    <nav class="navbar navbar-expand-md bg-primary navbar-dark sticky-top">
        <a class="navbar-brand"
           href="https://www.johannesfog.dk/globalassets/100-ar/fog-100-logo-animation-flip-126.gAif">FOG</a>
        <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <div class="dimenstioner">
        ...
        <div class="">
            ...
            <input required type="range" class="form-control-range" value=${qById.carport.width} min="240" max="750"
                   step="30"
                   id="customRange3" name="CarportWidth" oninput="amount.value=customRange3.value">
            <input disabled="disabled" class="outputshowcase" id="amount" type="number" value="${qById.carport.width}"
                   min="240" max="750"
                   oninput="customRange3.value=amount.value"/>
            <p><Strong>Carport længde:</strong></p>
            <input required type="range" class="form-control-range" value="${qById.carport.length}" min="240" max="780"
                   step="30"
                   id="customRange4" name="CarportLength" oninput="amount2.value=customRange4.value">
            <input disabled="disabled" class="outputshowcase" id="amount2" type="number" value="${qById.carport.length}"
                   min="240" max="780"
                   oninput="customRange4.value=amount2.value"/>
            <div class="form-check">
                <input name="includeShed" class="form-check-input" type="checkbox" value="on"
                       id="gridCheck"  ${requestScope.shedCheckbox} onclick="myFunction()">
    ...
    <div class="tag">
        ...
        <div class="tbd">
            ...
            <div class="Redskabsrum-længde">
                <input required type="range" class="form-control-range" value="${qById.carport.roofAngle}" min="10"
                       max="90" step="5"
                       id="rejsning" name="ShedLength" oninput="procent.value=rejsning.value">
                <input disabled="disabled" class="outputshowcase" id="procent" type="number"
                       value="${qById.carport.roofAngle}" min="10"
    ...
    <div class="final">
        <div class="finalbutton">
            <form method="post">
                <button name="SendTilbud" id="SendTilbud" class="SendTilbud">Send Tilbud/ Faktura</button>
            </form>
        </div>
